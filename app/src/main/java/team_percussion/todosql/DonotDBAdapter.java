...
public class DonotDBAdapter{
    private final static String DB_NAME = "donottodo.db";
    ...
    private DBHelper dbRecucer = null;
    protected Context context;

    //コンストラクタ
    public DonotDBAdapter(Context context) {
        this.context = context;
        dbRecucer = new DBHelper(this.context);
    }


    //DB_Read&Write
    public DonotDBAdapter openDB(){
        db = dbRecucer.getWritableDatabase();
        return this;
    }
    public DonotDBAdapter readDB(){
        db =dbRecucer.getReadableDatabase();
        return this;
    }
    public void closeDB(){
        db.close();
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db){
            //テーブル生成定義
            String createTbl = "CREATE TABLE " + DB_TABLE + " AS SELECT * FROM todoSheet";
